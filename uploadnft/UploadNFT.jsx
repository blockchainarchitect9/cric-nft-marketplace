    ...
    <div className={Style.upload}>
      ...
      <div className={Style.upload_box}>
        <div className={formStyle.Form_box_input}>
          ...
          <input
            type="text"
            placeholder="NFT Name(Mandatory)"
        ...
        <div className={formStyle.Form_box_input}>
          ...
          <p className={Style.upload_box_input_para}>
            CricNFTMarket will include a link to this URL on this item's detail
        ...
        <div className={formStyle.Form_box_input}>
          ...
          <textarea
            ...
            cols="30"
            rows="6"
            placeholder="NFT Description(Mandatory)"
